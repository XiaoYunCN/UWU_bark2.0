...
--------------------------------------------------------------------
local RenUi = library:AddWindow("☁️ bf汉化版",Enum.KeyCode.RightControl)
--------------------------------------------------------------------
...
Main:AddButton("删除效果伤害", function()
...
Main:AddToggle("自动设置繁殖点",true,function(value)
...
Main:AddToggle("带来暴民",true,function(value)
...
Main:AddSeperator("自动混战")

Main:AddToggle("汽车超人",_G.AutoSuperhuman,function(value)
...
Main:AddToggle("自动死亡步骤",_G.AutoDeathStep,function(value)
...
Main:AddToggle("自动沙克曼空手道",_G.AutoSharkman,function(value)
...
Main:AddToggle("汽车电动爪",_G.AutoElectricClaw,function(value)
...
Main:AddToggle("汽车龙塔隆",_G.AutoDragonTalon,function(value)
...
Main:AddToggle("自动农场BF掌握",_G.AutoFarmFruitMastery,function(value)
...
Main:AddToggle("自动农场枪掌握",_G.AutoFarmGunMastery,function(value)
...
local BossName = Main:AddDropdown(" Boss",Boss,function(value)
_G.SelectBoss = value
end)
...
Main:AddToggle("汽车农场Boss",_G.AutoFarmBoss,function(value)
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
...
Main:AddToggle("自动农场所有Boss",_G.AutoAllBoss,function(value)
_G.AutoAllBoss = value
StopTween(_G.AutoAllBoss)
end)

Main:AddToggle("自动农场所有Boss跳舞",_G.AutoAllBossHop,function(value)
...
Main:AddSeperator("多尔特")

local MobKilled = Main:AddLabel("被杀死的")
...
Main:AddToggle("汽车轮Boss",_G.AutoDoughtBoss,function(value)
...
Main:AddSeperator("高级地牢")

Main:AddToggle("自动推进地下城",_G.AutoAdvanceDungeon,function(value)
...
Main:AddSeperator("巴迪剑")

Main:AddToggle("汽车伙伴剑",_G.AutoBudySword,function(value)
_G.AutoBudySword = value
StopTween(_G.AutoBudySword)
end)

Main:AddToggle("汽车伙伴剑跳",_G.AutoBudySwordHop,function(value)
...
pcall(function()
while wait() do
EliteProgress:Set("精英进步: "..game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("EliteHunter","Progress"))
end
end)
end)
...
Main:AddToggle("汽车精英猎人Hop",_G.AutoEliteHunterHop,function(value)
_G.AutoEliteHunterHop = value
end)

Main:AddSeperator("圣镰刀")

Main:AddToggle("自动圣镰",_G.AutoFarmBossHallow,function(value)
_G.AutoFarmBossHallow = value
StopTween(_G.AutoFarmBossHallow)
end)

Main:AddToggle("自动圣镰跳",_G.AutoFarmBossHallowHop,function(value)
...
Main:AddToggle("自动黑暗匕首跳",_G.AutoDarkDagger_Hop,function(value)
...
Main:AddToggle("汽车天鹅眼镜",_G.AutoFarmSwanGlasses,function(value)
...
Main:AddToggle("汽车天鹅眼镜Hop",_G.AutoFarmSwanGlasses_Hop,function(value)
...
local BoneFarm = Main:AddToggle("自动农场骨",_G.Auto_Bone,function(value)
_G.Auto_Bone = value
...
while wait() do
pcall(function()
ObservationRange:Set("观察范围级别: "..math.floor(game:GetService("Players").LocalPlayer.VisionRadius.Value))
end)
end
end)
...
Main:AddToggle("自动农场观察站",_G.AutoObservation_Hop,function(value)
...
Main:AddSeperator("军刀")

Main:AddToggle("自动军刀",_G.AutoSaber,function(value)
_G.AutoSaber = value
StopTween(_G.AutoSaber)
end)

Main:AddToggle("自动军刀跳跃",_G.AutoSaber_Hop,function(value)
...
Main:AddSeperator("传奇之剑")

Main:AddToggle("汽车传奇之剑",_G.AutoBuyLegendarySword,function(value)
...
Main:AddToggle("汽车传奇剑舞",_G.AutoBuyLegendarySword_Hop,function(value)
_G.AutoBuyLegendarySword_Hop = value
end)

Main:AddSeperator("增强颜色")

Main:AddToggle("自动增强颜色",_G.AutoBuyEnchancementColour,function(value)
_G.AutoBuyEnchancementColour = value
end)

Main:AddToggle("自动跳舞",_G.AutoBuyEnchancementColour_Hop,function(value)
...
Main:AddSeperator("其他的")

Main:AddToggle("自动火枪手帽子",_G.AutoMusketeerHat,function(value)
...
Main:AddToggle("自动彩虹Haki",_G.Auto_Rainbow_Haki,function(value)
...
Main:AddToggle("自动彩虹Haki V2",_G.AutoObservationv2,function(value)
...
Main:AddToggle("汽车忍者",_G.AutoRengoku,function(value)
...
Main:AddToggle("自动农场外质",_G.AutoEctoplasm,function(value)
...
Main:AddToggle("汽车阎罗",_G.AutoYama,function(value)
_G.AutoYama = value
...
Main:AddToggle("自动进化赛车",_G.Auto_EvoRace,function(value)
...
Main:AddToggle("自动巴特里奥任务",_G.AutoBartilo,function(value)
...
local plyserv = Combat:AddLabel("玩家")
...
Combat:AddButton("恢复精神玩家",function()
Playerslist = {}
SelectedPly:Clear()
for i,v in pairs(game:GetService("Players"):GetChildren()) do
...
Combat:AddToggle("自动农场玩家",false,function(value)
...
Combat:AddToggle("Aimbot 枪",false,function(value)
_G.Aimbot_Gun = value
end)
...
Combat:AddToggle("Aimbot 技能",false,function(value)
...
Combat:AddToggle("使能够 PvP",false,function(value)
_G.EnabledPvP = value
end)
...
Combat:AddSeperator("邦蒂号")

local Current = Combat:AddLabel("当前奖金:")
...
Current:Set("当前奖金: "..Bounty1.." [ Max ]")
elseif tonumber(Bounty) < 25000000 then
Current:Set("当前奖金: "..Bounty1)
end
end)
end
end)
...
Earn:Set("获得: "..tonumber(Earned1))
end)
end
end)

Combat:AddToggle("自动农场奖金",_G.AutoFarmBounty,function(value)
...
Combat:AddToggle("自动农场赏金猎人",_G.AutoFarmBounty_Hop,function(value)
...
game:GetService("Players").LocalPlayer:Kick("成功了！赏金农场")
end
end)
end
end
...
local Pointstat = Stats:AddLabel("统计点数")

spawn(function()
while wait() do
pcall(function()
Pointstat:Set("统计点数: "..tostring(game:GetService("Players")["LocalPlayer"].Data.Points.Value))
end)
end
end)
...
Stats:AddToggle("汽车魔鬼水果",_G.Auto_DevilFruit,function(value)
_G.Auto_DevilFruit = value
end)

_G.PointStats = 1
Stats:AddSlider("选择点",1,100,1,function(value)
_G.PointStats = value
end)
...
while wait() do
pcall(function()
locallv:Set("等级:".." "..game:GetService("Players").LocalPlayer.Data.Level.Value)
end)
end
end)

local localrace = Stats:AddLabel("人种")

spawn(function()
while wait() do
pcall(function()
localrace:Set("种族:".." "..game:GetService("Players").LocalPlayer.Data.Race.Value)
end)
end
end)
...
while wait() do
pcall(function()
localbeli:Set("别雷 :".." "..game:GetService("Players").LocalPlayer.Data.Beli.Value)
end)
end
end)
...
while wait() do
pcall(function()
localexp:Set("经验点数:".." "..game:GetService("Players").LocalPlayer.Data.Exp.Value)
end)
end
end)
...
local localbountyhornor = Stats:AddLabel("邦蒂号")

spawn(function()
while wait() do
pcall(function()
localbountyhornor:Set("奖金/荣誉:".." "..game:GetService("Players").LocalPlayer.leaderstats["Bounty/Honor"].Value)
end)
end
end)
...
localDevil:Set("恶魔果实:".." "..game:GetService("Players").LocalPlayer.Data.DevilFruit.Value)
else
...
Stats:AddSeperator("假")

Stats:AddToggle("启用假",_G.EnabledStat,function(value)
...
Stats:AddTextbox("经历 ","",true,function(value)
if _G.EnabledStat then
game:GetService("Players")["LocalPlayer"].Data.Exp.Value = tonumber(value)
end
end)

Stats:AddTextbox("别雷","",true,function(value)
if _G.EnabledStat then
...
Stats:AddTextbox("防卫","",true,function(value)
if _G.EnabledStat then
...
Stats:AddTextbox("抢","",true,function(value)
if _G.EnabledStat then
...
Stats:AddTextbox("邦蒂号","",true,function(value)
if _G.EnabledStat then
game:GetService("Players")["LocalPlayer"].leaderstats["Bounty/Honor"].Value = tonumber(value)
end
end)

Teleport:AddSeperator("世界怪兽")

Teleport:AddButton("传送到旧世界",function()
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelMain")
end)

Teleport:AddButton("传送到第二个海洋",function()
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelDressrosa")
end)

Teleport:AddButton("传送到第三个海洋",function()
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelZou")
end)

Teleport:AddButton("传送到东海岸",function()
...
Teleport:AddSeperator("岛")

if World1 then
Teleport:AddDropdown("选择岛屿(英文名岛)",{
"WindMill",
"Marine",
"Middle Town",
"Jungle",
...
local TimeRaid = Dungeon:AddLabel("等待地牢")
...
Dungeon:AddToggle("自动农场地牢",_G.Auto_Dungeon,function(value)
...
Dungeon:AddToggle("汽车购买芯片",_G.AutoBuyChip,function(value)
...
Dungeon:AddButton("开始突袭",function()
if World2 then
fireclickdetector(game:GetService("Workspace").Map.CircleIsland.RaidSummon2.Button.Main.ClickDetector)
elseif World3 then
fireclickdetector(game:GetService("Workspace").Map["Boat Castle"].RaidSummon2.Button.Main.ClickDetector)
...
Dungeon:AddButton("然后岛",function()
pcall(function()
if game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 5") then
...
if World2 then
Dungeon:AddButton("觉醒室",function()
...
DevilFruit:AddToggle("自动购买水果狙击手",_G.AutoBuyFruitSniper,function(value)
...
DevilFruit:AddToggle("自动吃水果啤酒花",_G.AutoEatFruitHop,function(value)
...
DevilFruit:AddToggle("自动商店水果",_G.AutoStoreFruit,function(value)
...
Shop:AddButton("购买Geppo",function()
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Geppo")
end)

Shop:AddButton("购买Buso Haki",function()
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Buso")
end)

Shop:AddButton("购买 Soru",function()
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Soru")
end)

Shop:AddButton("购买 Observation(Ken) Haki",function()
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("KenTalk","Buy")
end)

Shop:AddSeperator("战斗风格")

Shop:AddButton("购买Black Leg",function()
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyBlackLeg")
end)
...
Shop:AddButton("购买 Fishman Karate",function()
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyFishmanKarate")
end)

Shop:AddButton("购买Dragon Claw",function()
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","DragonClaw","1")
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","DragonClaw","2")
end)

Shop:AddButton("购买Superhuman",function()
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySuperhuman")
end)

Shop:AddButton("购买Death Step",function()
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDeathStep")
end)
...
Shop:AddButton("购买Electric Claw",function()
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectricClaw")
end)

Shop:AddButton("购买Dragon Talon",function()
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDragonTalon")
end)
-----Shop----------------
Shop:AddSeperator("附件")

Shop:AddButton("巴卫环",function()
